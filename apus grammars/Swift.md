...
softIdentifier              = identifier ---( "_" "let" "var" "inout" )
                            | escapedIdentifier
...
interpolatedStringLiteral       = singleLineInterpolatedStringLiteral
...
singleLineInterpolatedStringLiteral = interpolatedStringLiteralHead
                                      ...
                                      { interpolatedStringLiteralPart functionCallArgumentList }
                                      interpolatedStringLiteralTail
                                    | extendedInterpolatedStringLiteralHead
                                      functionCallArgumentList
                                      { extendedInterpolatedStringLiteralPart functionCallArgumentList }
                                      extendedInterpolatedStringLiteralTail .

multilineInterpolatedStringLiteral  = multilineInterpolatedStringLiteralHead
                                      functionCallArgumentList
                                      { multilineInterpolatedStringLiteralPart functionCallArgumentList }
                                      multilineInterpolatedStringLiteralTail
                                    | extendedMultilineInterpolatedStringLiteralHead
                                      functionCallArgumentList
                                      { extendedMultilineInterpolatedStringLiteralPart functionCallArgumentList }
                                      extendedMultilineInterpolatedStringLiteralTail .
```
...
plainRegularExpressionLiteral = >n<
...
regularExpressionLiteral = plainRegularExpressionLiteral
                         | <-< ( "true" "false" "nil" "self" "Self" "super" "Any" "func" "operator"
                                  identifier escapedIdentifier implicitParameterName propertyWrapperProjection
                                  binaryLiteral octalLiteral decimalLiteral hexadecimalLiteral
                                  decimalFloatingPointLiteral hexadecimalFloatingPointLiteral
                                  regexSlash extendedRegularExpressionLiteral
...
postfixExpression = @prefer postfixExpression >s< postfixOperator <s>
                  | @cannotParse( keyPathExpression ) postfixExpression >s< postfixOperatorToken >+> ( "." ")" "]" "}" "," ";" ":" EOF )
...
trailingClosures = @cannotParse(willSetDidSetBlock accessorBlockBrace) closureExpression >-> ( "else" ) labeledTrailingClosures? .
...
variableDeclaration = variableDeclarationHead variableName typeAnnotation initializer initializedAccessorBlock .
...
functionSignature = parameterClause "async"? declarationThrowsClause? functionResult? .
functionResult = "->" type .
...
abiSubscriptDeclaration = subscriptHead subscriptResult genericWhereClause? .
