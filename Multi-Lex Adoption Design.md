...
**Validation:** full sweep, plus the test bed for `Array<Array<Int>>` derivation count (still ambiguous at grammar level, controlled by the grammar-predicate lookahead family, `Grammar Predicate Lookahead Design`).
